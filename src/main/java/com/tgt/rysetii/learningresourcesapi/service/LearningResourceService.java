...
public class LearningResourceService {
    ...
    private LearningResource createLearningResource(String[] attributes){
        ...
        LearningResourceStatus resourcestatus = LearningResourceStatus.valueOf(attributes[4]);
        ...
        LearningResource learningResource = new LearningResource(id, name, costPrice, sellingPrice, resourcestatus, createdDate, publishedDate, retiredDate);
