...
public class LearningResourceService {
    ...
    public List<LearningResource> getLearningResources(){
        ...
        List<LearningResource> learningResources = readLearningResourceFromCsv(learningResourcesFile);
    ...
    private List<LearningResource> readLearningResourceFromCsv(File csvFile){
    ...
    private void populateLearningResourcesToCsv(List<LearningResource> learningResources){
        ...
        try {
            ...
            for (LearningResource learningResource : learningResources) {
                ...
                singleLine.append(csvDelimiter);
                singleLine.append(learningResource.getResourceStatus());
                singleLine.append(csvDelimiter);
